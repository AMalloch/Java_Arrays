...
public class ArrayTest {
    ...
    public void before(){
        ...
        // this is making an array called ArrayList passing in [1, 2, 3, 4]
        // then assigning it to numbers making it numbers = [1, 2, 3, 4]
        // arrayListExample is the class
        // <Integer> is the type of array
    }
    ...
    // VCS create new repository, then bottom icon left, version control
}
